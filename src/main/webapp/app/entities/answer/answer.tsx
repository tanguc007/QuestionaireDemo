    ...
    return (
      <div>
        <h2 id="answer-heading">
          <Translate contentKey="questionaireDemoApp.answer.home.title">Answers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="questionaireDemoApp.answer.home.createLabel">Create a new Answer</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {answerList && answerList.length > 0 ? (
            ...
            <div className="alert alert-warning">
              <Translate contentKey="questionaireDemoApp.answer.home.notFound">No Answers found</Translate>
            </div>
          )}
        </div>
      </div>
